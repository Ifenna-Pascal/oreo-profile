    ...
    <div className='relative mb-12'>
        ...
        <div className='centered-main-container w-full '>
            <div className='flex flex-col '>
                ...
                <h1 className={`${poppins.className} text-[42px] text-primary-300 font-[400]`}>Oreo <span className='font-semibold'>Hospital</span></h1>
                <p className={`${ poppins.className} text-[15px] text-gray-500 w-[350px] mb-4 py-2`}>Contrary to popular belief, Lorem Ipsum is not simply random text</p>
