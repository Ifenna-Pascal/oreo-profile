...
const Contact = () => {
  return (
    ...
    <h1 className={`font-[300] ${poppins.className} text-primary-300 text-[28px] text-center w-[220px] md:w-full py-2   md:text-[32px]`}>We provide 24/7 customer support.</h1>
    ...
    {/* <Button text='Read More' variant={'outlined_text'} size={'small'} className='rounded-none mt-3'/> */}
</div>
  )
}
