...
const Contact = () => {
  return (
    ...
    <h1 className={`font-[300] ${poppins.className} text-primary-300 text-[28px] text-center w-[220px] md:w-full py-4 md:text-left  md:text-[32px]`}>We provide 24/7 customer support.</h1>
