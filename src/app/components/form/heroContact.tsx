...
export function HeroContact() {
  return (
    <div className='flex flex-col p-6 absolute -bottom-[140px] md:-bottom-[100px] mb-5 md:mb-0 shadow-md md:left-[13%] bg-white max-w-[94%] left-[3%] w-full md:centered-main-container rounded-[8px]  min-h-[186px]'>
